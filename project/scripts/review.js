...
function calculateAverageRating() {
    ...
    for (let i = 1; i <= parseInt(localStorage.getItem('reviewCount') || '0'); i++) {
...
function logAnalytics() {
    ...
    console.log('Review Analytics:', {
        ...
        hasWrittenReview: !!(params['written-review'] && params['written-review'].trim()),
...
function handleErrors() {
    window.addEventListener('error', function(event) {
        ...
        errorDiv.style.cssText = `
            ...
            text-align: center;
        `;
        errorDiv.textContent = 'There was an issue loading your review details, but your review was still submitted successfully!';
